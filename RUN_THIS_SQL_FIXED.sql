...
DROP POLICY IF EXISTS "Allow all operations on failed_clock_attempts" ON failed_clock_attempts;
...
-- Success message
SELECT 'Database setup complete! Face recognition is ready.' as message;
